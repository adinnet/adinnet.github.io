...
var JqueryDialog = {
	...
	init:function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag){
		...
		//header left
		_jd_dialog_m_h.append("<span id='jd_dialog_m_h_l' class='"+dialogTitle+"'><span id='jd_dialog_m_h_r' title='" + JqueryDialog.cCloseTitle + "' onclick='JqueryDialog.Close();'></span></span>");
		...
		$("#jd_dialog_m_b_2").append("<div id='jd_iframe' style='width:"+iframeWidth+"px;height:"+iframeHeight+"px'>"+iframeSrc+"</div>");
